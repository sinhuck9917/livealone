...
import com.example.livealone4.Adapters.MessageAdapter;
...
public class FirebaseMessenger {
    ...
    /*
        ...
        writeChat() : CREATE Chat 깉이먹기가 진행될 때 채팅 생성
        destroyChat() : DESTROY Chat 같이먹기가 중단될 때 채팅 제거
