...
import com.example.livealone4.Firebase.FirebaseMessenger;
import com.example.livealone4.Models.Message;
...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(MainActivity.getLiveAloneOfCurrentUser() == null || MainActivity.getUidOfCurrentUser() == null){
    ...
    private void initFirebase() {
        firebaseMessenger = new FirebaseMessenger(MessageActivity.this, MainActivity.getUidOfOpponentUser(), MainActivity.getLiveAloneOfCurrentUser().getKey(), true);
    ...
    private void initView() {
        ...
        messageSendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(firebaseMessenger == null || MainActivity.getLiveAloneOfCurrentUser() == null){
                    Toast.makeText(MessageActivity.this, "잠시 뒤에 다시 시도해주세요.", Toast.LENGTH_SHORT).show();
                    return;
                }

                //보내기
                firebaseMessenger.sendMessage(MainActivity.getLiveAloneOfCurrentUser().getKey(),new Message(MainActivity.getUidOfCurrentUser(), message));
