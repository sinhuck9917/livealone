...
public class MyPageFragment extends Fragment {
    ...
    private static TextView nameText, starText, livealoneCountText, locText, emailText
            , birthText, phoneText, susText;
    ...
    private void initView(View view) {
        ...
        livealoneCountText= view.findViewById(R.id.live_alone_count_in_fragment_my_page);
    ...
    public static void setView(){
        ...
        livealoneCountText.setText(MainActivity.getCurrentUser().getLivealoneCount() + "회");
